...
date:       2018-01-30                  
author:     HuberyYang                
header-img: img/article_head_trend.jpg  
catalog:    true                     
tags:                             
    - iOS
    - OC
...
以上即为走势图中较重要的部分，完整的Demo地址：[https://github.com/HuberyYang/LotteryTrend.git](https://github.com/HuberyYang/LotteryTrend.git)
